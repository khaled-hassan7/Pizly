...
function Button({ children, disabled, to, type, onClick }) {
  const base =
    ' text-sm transtion-colors rounded-full bg-yellow-400  font-semibold text-stone-800 duration-300 hover:bg-yellow-300 focus:bg-yellow-300 focus:outline-none focus:ring focus:ring-yellow-300 focus:ring-offset-2 disabled:cursor-not-allowed';

  const style = {
    primary: base + ' px-4 py-3  md:px-6 md:py-4',
    small: base + ' px-4 py-2  md:px-5 md:py-2.5 text-xs  ',
    rounde: base + ' px-1.5 py-0.5  md:px-3 md:py-1.5 text-xs ',
    secondary:
