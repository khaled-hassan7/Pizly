...
function SlidePanel({ children, setIsOpen, isOpen }) {
  ...
  return (
    <div
      className={`fixed inset-y-0 right-0 z-[100] flex h-[100dvh] w-full touch-none flex-col bg-white shadow-2xl transition-transform duration-[800ms] ease-[cubic-bezier(0.33,1,0.68,1)] sm:w-[500px] ${isOpen ? 'translate-x-0' : 'translate-x-full'} `}
    >
